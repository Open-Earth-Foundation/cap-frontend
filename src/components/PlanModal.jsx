                    ...
                    <div className="px-6 py-4 space-y-4 max-h-[70vh] overflow-y-auto">
                        <div className="space-y-4">
                            ...
                            <div className="bg-white p-4 rounded-lg">
                                ...
                                <ReactMarkdown className="prose prose-lg max-w-none prose-h2:text-xl prose-h2:font-semibold prose-h2:text-blue-600 prose-h2:mt-6 prose-h2:mb-4 prose-h2:border-b prose-h2:pb-2 prose-ul:list-disc prose-ul:pl-5 prose-li:mb-1 prose-strong:text-gray-700">
                                    {plan}
                                </ReactMarkdown>
                            </div>
                        </div>
