...
const ClimateActions = ({
    ...
    const createTable = (columns, enableRowOrdering, rankedData, setRankedData, type) => {
    ...
    const onSaveRankings = async () => {
        setIsSaving(true)
        await writeFile(selectedCity, [...rankedDataMitigation, ...rankedDataAdaptation])
                            ...
                            <div className="flex justify-between mt-12 mb-8">
                                ...
                                <div className="flex gap-4">
                                    ...
                                    {enableRowOrdering && <>
                                        ...
                                        >
                                            <div>
                                                {isSaving ? <GiSandsOfTime />:<MdOutlineSave/>}
                                            </div>
                                            SAVE RANKINGS
                                        </button>
                                    </>}
